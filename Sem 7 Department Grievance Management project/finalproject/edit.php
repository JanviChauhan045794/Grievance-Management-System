...
if (isset($_POST['update_profile'])) {
    ...
    $edit_query = mysqli_query($con, "UPDATE users SET firstname='$firstname', lastname='$lastname', email='$email' WHERE user_id='$user_id' AND role='student'");
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = mysqli_query($con, "SELECT firstname, lastname, email FROM users WHERE user_id='$user_id' AND role='student'");
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#">Department Grievance Management System</a>
        <div class="ml-auto">
